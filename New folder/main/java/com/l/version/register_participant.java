...
public class register_participant extends AppCompatActivity {
    String college, username  ,password , email , contact;

    register_participant(String college ,String username ,String password ,String email ,String contact)
    {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit = (Button)findViewById(R.id.run);
        p[0] = (EditText)findViewById(R.id.participant_1);
        c[0] = (EditText)findViewById(R.id.contact_1);
        p[1] = (EditText)findViewById(R.id.participant_2);
        c[1] = (EditText)findViewById(R.id.contact_2);
        p[2] = (EditText)findViewById(R.id.participant_3);
        c[2] = (EditText)findViewById(R.id.contact_3);
        p[3] = (EditText)findViewById(R.id.participant_4);
        c[3]= (EditText)findViewById(R.id.contact_4);
        p[4] = (EditText)findViewById(R.id.participant_5);
        c[4] = (EditText)findViewById(R.id.contact_5);
        gender[0] = (EditText)findViewById(R.id.gender_1);
        gender[1] = (EditText)findViewById(R.id.gender_2);
        gender[2] = (EditText)findViewById(R.id.gender_3);
        gender[3] = (EditText)findViewById(R.id.gender_4);
        gender[4] = (EditText)findViewById(R.id.gender_5);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    for (int i = 0; i < a; i++) {
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                            if (!isValidUsername(p[i].getText().toString())) {
                                ...
                                Toast.makeText(register_participant.this, "Syntactical Error", Toast.LENGTH_SHORT).show();
                                p[i].requestFocus();
                                status = 1;
                            } else if (!isValidContact(c[i].getText().toString())) {
                                c[i].setError("Invalid Contact");
                                Toast.makeText(register_participant.this, "10 Integers Allowed", Toast.LENGTH_SHORT).show();
                                c[i].requestFocus();
                                ...
                                Toast.makeText(register_participant.this, "right the correct gender", Toast.LENGTH_SHORT).show();
                ...
                } else
                {
                    ...
                    Toast.makeText(register_participant.this, "Fill it!", Toast.LENGTH_SHORT).show();
                    submit.requestFocus();
                }
                ...
                if (status == 0) {
                    LoadData data = new LoadData(register_participant.this);
